      ...
      <div className="hero min-h-screen bg-gray-800">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="text-center lg:text-center">
            <h1 className="text-5xl mb-4 font-bold  text-white font-bold underline decoration-yellow-400">
              Login Please !
            </h1>
            <img src={LoginPic} alt="" />
          </div>
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <p className="text-xl bg-red-500 text-white rounded-xl mt-4 mx-2 font-semibold">
              {error}
            </p>
            <form onSubmit={SubmitForm} className="card-body">
              ...
              <div className="form-control">
                ...
                />
                <label className="label">
                  <Link className="text-red-600 underline label-text-alt link link-hover">
                    Forgot password?
                  </Link>
                  <Link
                    to="/register"
                    className="text-blue-600 label-text-alt link text-xs link-hover"
                  >
                    {" "}
                    Create Account !
                  </Link>
            ...
            <section className=" p-2 mx-auto">
              ...
              >
                <img
                  className="w-12 bg-gray-800 rounded-full"
                  src={google}
                  alt=""
                />
