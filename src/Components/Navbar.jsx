                        ...
                        <ul class="flex items-center hidden space-x-8 lg:flex">
                            ...
                            <li>
                                <Link
                                    ...
                                    class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400"
                                >
                                    <label for="Toggle2" className="inline-flex items-center space-x-4 cursor-pointer dark:text-white">
                                        <span>Dark</span>
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            ...
                                            <div>
                                                <button
                                                    ...
                                                    title="Close Menu"
                                                    class="p-2 mx-12 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                                                    onClick={() => setIsMenuOpen(false)}
                                                >
                                                    <svg class="w-8  text-gray-600" viewBox="0 0 24 24">
                                                        <path
                                                            fill="currentColor"
                                            ...
                                            <ul class="space-y-4">
                                                ...
                                                <li>
                                                    <Link
                                                        ...
                                                        class="font-medium tracking-wide text-gray-900 transition-colors duration-200 hover:text-teal-accent-400"
                                                    >
                                                        <label for="Toggle2" className="inline-flex items-center space-x-4 cursor-pointer dark:text-red-900">
                                                            <span>Dark</span>
                                                            <span className="relative">
                                                                <input id="Toggle2" type="checkbox" className="hidden peer" />
