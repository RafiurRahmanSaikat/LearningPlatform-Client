      ...
      <div className="hero min-h-screen bg-gray-800  mx-auto   ">
        <div className="hero-content  flex-col lg:flex-row-reverse">
          <div className="text-center lg:text-center">
            <h1 className="text-5xl text-white font-bold underline decoration-yellow-400">
              {" "}
              Please Complete Registration
            </h1>
            <img
              className="rounded-full ml-16 mt-4 w-[80%]"
              src={RegPic}
              alt=""
            />
          </div>
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <form onSubmit={SubmitForm} className="card-body">
              ...
              <Link
                to="/login"
                className="text-red-600 underline label-text-alt link link-hover"
              >
